            ...
            <div className="flex items-center space-x-4 sm:space-x-6">
              ...
              <div className="flex items-center space-x-2.5 pl-3 border-l border-slate-200 dark:border-slate-800">
                <button
                  ...
                  className="inline-flex items-center rounded-xl border border-slate-200 bg-slate-50 p-2 text-xs font-semibold text-slate-600 hover:bg-slate-100 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 transition"
                >
